 ...
 */
class modSimplePOS extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 731002004;
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'simplePOS';
		...
		// (where XXX is value of numeric property 'numero' of module)
		$this->description = "POS semplificato per la stampa degli scontrini";
		...
		$this->picto = 'pictovalue@simplePOS'; // mypicto@mymodule
		...
		$this->module_parts = array(
			...
			'css' => array('simplePOS/css/style.css.php'),
			// Set this to relative path of js file if module must load a js on all pages
			//'js' => array('simplePOS/js/jquery.editable.select.min.js','simplePOS/js/functions.js'),
		...
		$this->config_page_url = array("admin.php@simplePOS");
		...
		$this->langfiles = array("simplePOS@simplePOS");
		// Constants
	...
	{
		return $this->_load_tables('/simplePOS/sql/');
	}
}
